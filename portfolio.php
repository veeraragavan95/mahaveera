  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="text-white font-tertiary">My <br>Favourite Pictures</h1>
      </div>
    </div>
  </div>
  <!-- background shapes -->
...
<section class="section">
  <div class="container">
    <div class="col-lg-12 mx-auto" align="right">
      <a href="portfolioAdd.php"><button class="btn btn-success">Add</button></a>
    </div><br>
    <div class="row mb-5">
      <div class="col-12">
        <div class="btn-group btn-group-toggle justify-content-center d-flex" data-toggle="buttons">
          ...
          <label class="btn btn-sm btn-primary">
            <input type="radio" name="shuffle-filter" value="happy" />HAPPY
          </label>
          <label class="btn btn-sm btn-primary">
            <input type="radio" name="shuffle-filter" value="angry" />ANGRY
          </label>
          <label class="btn btn-sm btn-primary">
            <input type="radio" name="shuffle-filter" value="love" />LOVE
          </label>
        </div>
      </div>
    </div>
    <div class="row shuffle-wrapper">
      <?php
          ...
          $getvalues = mysqli_query($connection,"SELECT * FROM mahaselfie");
      ...
      ?>
        ...
        <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;<?php echo $mindset; ?>&quot;]">
        <div class="position-relative rounded hover-wrapper">
          <img src="images/portfolio/<?php echo $PhotoName; ?>.jpg" alt="portfolio-image" class="img-fluid rounded w-100 d-block">
          <div class="hover-overlay">
            <div class="hover-content">
              <a class="btn btn-light btn-sm" href="#!"><?php echo $PhotoDescription; ?></a>
            </div>
          </div>
        </div>
      </div>
...
<footer class="bg-dark footer-section">
  ...
  <div class="border-top text-center border-dark py-5">
    <p class="mb-0 text-light">Copyright &copy;<script>
      ...
      </script> happyed &amp; Developed by <a class="text-white-50" href="https://veeraragavan95.wordpress.com/">Veera Ragavan</a></p>
  </div>
</footer>
<!-- /footer -->
